...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="min-h-screen bg-gray-100" data-v-81f98a3e><div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8" id="cover-letter-container" data-v-81f98a3e>`);
      if (loading.value) {
        _push(`<div class="text-center py-16" data-v-81f98a3e><div class="animate-spin w-8 h-8 border-4 border-indigo-600 border-t-transparent rounded-full mx-auto mb-4" data-v-81f98a3e></div><p class="text-gray-600" data-v-81f98a3e>Loading cover letter...</p></div>`);
      } else if (!coverLetterData.value) {
        _push(`<div class="max-w-4xl mx-auto" data-v-81f98a3e>`);
        if (!unref(jobId)) {
          _push(`<div class="card text-center" data-v-81f98a3e><div class="w-20 h-20 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6 border border-gray-200" data-v-81f98a3e><svg class="w-10 h-10 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-81f98a3e><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-81f98a3e></path></svg></div><h2 class="text-3xl font-bold text-gray-900 mb-4" data-v-81f98a3e>No Job Selected</h2><p class="text-lg text-gray-600 mb-8 max-w-2xl mx-auto" data-v-81f98a3e> Please go back to your jobs and select a job to generate a cover letter. </p>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-81f98a3e${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-81f98a3e${_scopeId}></path></svg><span data-v-81f98a3e${_scopeId}>Back to Jobs</span>`);
              } else {
                return [
          ...
          _push(`<div class="card mb-8" data-v-81f98a3e><div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6" data-v-81f98a3e><h2 class="text-2xl font-bold text-gray-900 flex items-center" data-v-81f98a3e><div class="w-2 h-8 bg-gradient-to-b from-indigo-500 to-purple-600 rounded-full mr-4" data-v-81f98a3e></div> Job Description </h2></div><textarea placeholder="Paste the job description here... Include role requirements, company information, and key responsibilities." rows="8" class="w-full bg-gray-50 border border-gray-300 rounded-2xl px-6 py-4 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300" data-v-81f98a3e>${ssrInterpolate(jobDescription.value)}</textarea><div class="mt-6 flex justify-center" data-v-81f98a3e><button${ssrIncludeBooleanAttr(!jobDescription.value.trim() || generatingCoverLetter.value) ? " disabled" : ""} class="bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-8 py-4 rounded-2xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center space-x-3" data-v-81f98a3e>`);
          if (generatingCoverLetter.value) {
            _push(`<svg class="animate-spin w-5 h-5" fill="none" viewBox="0 0 24 24" data-v-81f98a3e><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-81f98a3e></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" data-v-81f98a3e></path></svg>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<span data-v-81f98a3e>${ssrInterpolate(generatingCoverLetter.value ? "Generating..." : "Generate New")}</span></button></div>`);
          if (unref(userCredits) < 1) {
            _push(`<div class="bg-red-50 border border-red-200 rounded-lg p-4 mt-6" data-v-81f98a3e><div class="flex items-center gap-3" data-v-81f98a3e><svg class="w-5 h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-81f98a3e><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" data-v-81f98a3e></path></svg><div data-v-81f98a3e><h3 class="text-sm font-medium text-red-800" data-v-81f98a3e>No Credits Available</h3><p class="text-sm text-red-700 mt-1" data-v-81f98a3e> You need at least 1 credit to generate a cover letter. <button class="font-medium underline hover:no-underline" data-v-81f98a3e> Purchase credits here </button></p></div></div></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
      ...
      if (coverLetterData.value) {
        _push(`<div class="space-y-8" data-v-81f98a3e><div class="flex flex-col sm:flex-row sm:justify-between sm:items-center bg-white rounded-2xl p-6 border border-gray-200 shadow-sm gap-4" data-v-81f98a3e><div class="flex flex-col sm:flex-row sm:items-center gap-4" data-v-81f98a3e><h2 class="text-2xl font-bold text-gray-900" data-v-81f98a3e>Your Cover Letter</h2></div><div class="flex flex-wrap gap-3" data-v-81f98a3e>`);
        if (unref(jobId)) {
          _push(`<div data-v-81f98a3e>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-81f98a3e${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-v-81f98a3e${_scopeId}></path></svg> Back to Resume `);
              } else {
                return [
                  (openBlock(), createBlock("svg", {
                    class: "w-4 h-4 mr-2",
        ...
        ])}" data-v-81f98a3e><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-81f98a3e><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" data-v-81f98a3e></path></svg><span data-v-81f98a3e>${ssrInterpolate(editMode.value ? "Save Changes" : "Edit Mode")}</span></button><button${ssrIncludeBooleanAttr(downloadingPDF.value) ? " disabled" : ""} class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-xl font-medium shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none" data-v-81f98a3e>`);
        if (downloadingPDF.value) {
          _push(`<svg class="animate-spin w-4 h-4" fill="none" viewBox="0 0 24 24" data-v-81f98a3e><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-81f98a3e></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" data-v-81f98a3e></path></svg>`);
        } else {
          _push(`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-81f98a3e><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-81f98a3e></path></svg>`);
        }
        _push(`<span data-v-81f98a3e>${ssrInterpolate(downloadingPDF.value ? "Generating PDF..." : "Download PDF")}</span></button><button${ssrIncludeBooleanAttr(generatingCoverLetter.value) ? " disabled" : ""} class="bg-indigo-500 hover:bg-indigo-600 text-white px-4 py-2 rounded-xl font-medium shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none" data-v-81f98a3e><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-81f98a3e><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" data-v-81f98a3e></path></svg><span data-v-81f98a3e>Regenerate</span></button></div></div>`);
        if (unref(userCredits) < 1) {
          _push(`<div class="bg-red-50 border border-red-200 rounded-lg p-4" data-v-81f98a3e><div class="flex items-center gap-3" data-v-81f98a3e><svg class="w-5 h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-81f98a3e><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" data-v-81f98a3e></path></svg><div data-v-81f98a3e><h3 class="text-sm font-medium text-red-800" data-v-81f98a3e>No Credits Available</h3><p class="text-sm text-red-700 mt-1" data-v-81f98a3e> You need at least 1 credit to regenerate a cover letter. <button class="font-medium underline hover:no-underline" data-v-81f98a3e> Purchase credits here </button></p></div></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm" data-v-81f98a3e><h3 class="text-lg font-bold text-gray-900 mb-4" data-v-81f98a3e>Choose Template</h3><div class="grid grid-cols-1 md:grid-cols-2 gap-4" data-v-81f98a3e><button class="${ssrRenderClass([
        ...
        ])}" data-v-81f98a3e><div class="flex items-center space-x-3" data-v-81f98a3e><div class="w-8 h-8 bg-gray-800 rounded-lg flex items-center justify-center" data-v-81f98a3e><svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-81f98a3e><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-81f98a3e></path></svg></div><div data-v-81f98a3e><h4 class="font-semibold text-gray-900" data-v-81f98a3e>Classic</h4><p class="text-sm text-gray-600" data-v-81f98a3e>Traditional, professional layout</p></div></div></button><button class="${ssrRenderClass([
          "p-4 rounded-xl border-2 transition-all duration-300 text-left",
        ...
        ])}" data-v-81f98a3e><div class="flex items-center space-x-3" data-v-81f98a3e><div class="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg flex items-center justify-center" data-v-81f98a3e><svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-81f98a3e><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" data-v-81f98a3e></path></svg></div><div data-v-81f98a3e><h4 class="font-semibold text-gray-900" data-v-81f98a3e>Modern</h4><p class="text-sm text-gray-600" data-v-81f98a3e>Contemporary design with gradients</p></div></div></button></div></div><div id="cover-letter-content" class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden" data-v-81f98a3e>`);
        ...
        if (editMode.value) {
          _push(`<div class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4" data-v-81f98a3e><div class="bg-white rounded-2xl p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto" data-v-81f98a3e><h3 class="text-xl font-bold text-gray-900 mb-4" data-v-81f98a3e>Edit Cover Letter</h3><p class="text-gray-600 mb-4" data-v-81f98a3e>Click on any section below to edit it:</p><div class="space-y-4" data-v-81f98a3e><button class="w-full p-4 border border-gray-200 rounded-xl text-left hover:bg-gray-50 transition-colors" data-v-81f98a3e><h4 class="font-semibold text-gray-900" data-v-81f98a3e>Cover Letter Text</h4><p class="text-sm text-gray-600" data-v-81f98a3e>Edit the main cover letter content</p></button><button class="w-full p-4 border border-gray-200 rounded-xl text-left hover:bg-gray-50 transition-colors" data-v-81f98a3e><h4 class="font-semibold text-gray-900" data-v-81f98a3e>Experience Highlights</h4><p class="text-sm text-gray-600" data-v-81f98a3e>Edit company achievements and highlights</p></button><button class="w-full p-4 border border-gray-200 rounded-xl text-left hover:bg-gray-50 transition-colors" data-v-81f98a3e><h4 class="font-semibold text-gray-900" data-v-81f98a3e>Key Skills Match</h4><p class="text-sm text-gray-600" data-v-81f98a3e>Edit skills alignment and relevance</p></button></div><div class="mt-6 flex justify-end space-x-3" data-v-81f98a3e><button class="px-4 py-2 text-gray-600 hover:text-gray-800 transition-colors" data-v-81f98a3e> Cancel </button></div></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
      ...
      if (showRegenerateModal.value) {
        _push(`<div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50" data-v-81f98a3e><div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white" data-v-81f98a3e><div class="mt-3" data-v-81f98a3e><h3 class="text-lg font-medium text-gray-900 mb-4" data-v-81f98a3e>Regenerate Cover Letter</h3><p class="text-sm text-gray-600 mb-4" data-v-81f98a3e>Provide additional instructions or feedback to improve your cover letter:</p><textarea rows="6" class="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 mb-4" placeholder="e.g., Make it more formal, emphasize leadership experience, focus on technical skills, etc." data-v-81f98a3e>${ssrInterpolate(regeneratePrompt.value)}</textarea><div class="flex justify-end space-x-3" data-v-81f98a3e><button class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500" data-v-81f98a3e> Cancel </button><button${ssrIncludeBooleanAttr(generatingCoverLetter.value) ? " disabled" : ""} class="px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50" data-v-81f98a3e>${ssrInterpolate(generatingCoverLetter.value ? "Regenerating..." : "Regenerate")}</button></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const coverLetter = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-81f98a3e"]]);

export { coverLetter as default };
//# sourceMappingURL=cover-letter-DN9sO9Na.mjs.map
