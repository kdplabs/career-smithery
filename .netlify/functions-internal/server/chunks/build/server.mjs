...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BPFevTLc.mjs')
  },
  {
    name: "tasks",
    path: "/tasks",
    component: () => import('./tasks-Xp7pgbEX.mjs')
  },
  {
    name: "credits",
    path: "/credits",
    component: () => import('./credits-CNTTFlPy.mjs')
  },
  {
    name: "summary",
    path: "/summary",
    component: () => import('./summary-QE4_dL63.mjs')
  },
  {
    name: "support",
    path: "/support",
    component: () => import('./support-CyA_JnB3.mjs')
  },
  {
    name: "assessment",
    path: "/assessment",
    component: () => import('./assessment-D8ora9ws.mjs')
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-0pqQH860.mjs')
  },
  {
    name: "jobs",
    path: "/jobs",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./index-CpkMmLj6.mjs')
  },
  {
    name: "blog-slug",
    path: "/blog/:slug()",
    component: () => import('./_slug_-Bfbxue3X.mjs')
  },
  {
    name: "cover-letter",
    path: "/cover-letter",
  ...
  },
  {
    ...
    component: () => import('./callback-BxRfkd_A.mjs')
  },
  {
    name: "report-wizard",
    path: "/report-wizard",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./report-wizard-BmArLf4J.mjs')
  },
  {
    name: "resume-wizard",
    path: "/resume-wizard",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./resume-wizard-zjoms-pC.mjs')
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    component: () => import('./privacy-policy-_YDcpR-H.mjs')
  },
  {
    name: "resume-summary",
    path: "/resume-summary",
    meta: __nuxt_page_meta || {},
    component: () => import('./resume-summary-C_IUVV9N.mjs')
  },
  {
    name: "assessment-guide",
    path: "/assessment-guide",
    component: () => import('./assessment-guide-bmLpWse1.mjs')
  },
  {
    name: "terms-of-service",
    path: "/terms-of-service",
    component: () => import('./terms-of-service-BlQHzSNp.mjs')
  },
  {
    name: "personalized-report",
    path: "/personalized-report",
    component: () => import('./personalized-report-DdKmkW25.mjs')
  },
  {
    name: "solutions-career-planner",
    path: "/solutions/career-planner",
    component: () => import('./career-planner-DPDxOTcm.mjs')
  },
  {
    name: "solutions-resume-builder",
    path: "/solutions/resume-builder",
    component: () => import('./resume-builder-Be1Nrhft.mjs')
  }
];
...
const LazyAccordionList = defineAsyncComponent(() => import('./AccordionList-Cz-SboiS.mjs').then((r) => r["default"] || r.default || r));
const LazyCalloutBox = defineAsyncComponent(() => import('./CalloutBox-CpRWS9n9.mjs').then((r) => r["default"] || r.default || r));
const LazyChecklistBox = defineAsyncComponent(() => import('./ChecklistBox-C7LmUlk2.mjs').then((r) => r["default"] || r.default || r));
const LazyCodeBlock = defineAsyncComponent(() => import('./CodeBlock-BNP5iCHY.mjs').then((r) => r["default"] || r.default || r));
const LazyComparisonTable = defineAsyncComponent(() => import('./ComparisonTable-c1OnsfhU.mjs').then((r) => r["default"] || r.default || r));
const LazyFeatureGrid = defineAsyncComponent(() => import('./FeatureGrid-DIwM7OTe.mjs').then((r) => r["default"] || r.default || r));
const LazyHighlightBox = defineAsyncComponent(() => import('./HighlightBox-BMk9b70f.mjs').then((r) => r["default"] || r.default || r));
const LazyImageComparison = defineAsyncComponent(() => import('./ImageComparison-Bg8j4iEH.mjs').then((r) => r["default"] || r.default || r));
const LazyNewsletterSignup = defineAsyncComponent(() => import('./NewsletterSignup-BQxGJVsc.mjs').then((r) => r["default"] || r.default || r));
const LazyProConsList = defineAsyncComponent(() => import('./ProConsList-B4uJBXSy.mjs').then((r) => r["default"] || r.default || r));
const LazyQuoteBlock = defineAsyncComponent(() => import('./QuoteBlock-Drxukql9.mjs').then((r) => r["default"] || r.default || r));
const LazyReadingProgress = defineAsyncComponent(() => import('./ReadingProgress-CKTJyYv8.mjs').then((r) => r["default"] || r.default || r));
const LazyResourceCard = defineAsyncComponent(() => import('./ResourceCard-DLlBD6HH.mjs').then((r) => r["default"] || r.default || r));
const LazyShareButtons = defineAsyncComponent(() => import('./ShareButtons-DkIZh3EL.mjs').then((r) => r["default"] || r.default || r));
const LazyStatsGrid = defineAsyncComponent(() => import('./StatsGrid-CMH9Z99o.mjs').then((r) => r["default"] || r.default || r));
const LazyStepList = defineAsyncComponent(() => import('./StepList-CYUjPH9l.mjs').then((r) => r["default"] || r.default || r));
const LazyTableOfContents = defineAsyncComponent(() => import('./TableOfContents-C2xY_7b0.mjs').then((r) => r["default"] || r.default || r));
const LazyTimelineBlock = defineAsyncComponent(() => import('./TimelineBlock-BqVjvYx7.mjs').then((r) => r["default"] || r.default || r));
const LazyTipBox = defineAsyncComponent(() => import('./TipBox-CL6iXLQ8.mjs').then((r) => r["default"] || r.default || r));
const LazyVideoEmbed = defineAsyncComponent(() => import('./VideoEmbed-BjoDcnpH.mjs').then((r) => r["default"] || r.default || r));
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-DmOIvGm-.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-CFDaJmL7.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-CwtF7lBJ.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-Bdwg4NoN.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-i6ZtBeqF.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-BPm_6qCo.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BCkWJhAY.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-CbwP6_yy.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-CyrAPkkc.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-CmBGPnSm.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-D1v8Ez96.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-C9IUl37e.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-DfdxyfGo.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-C7cLrOZi.mjs').then((r) => r["default"] || r.default || r));
...
const LazyIcon = defineAsyncComponent(() => import('./index-BV-WvbVW.mjs').then((r) => r["default"] || r.default || r));
const lazyGlobalComponents = [
  ["AccordionList", LazyAccordionList],
  ["CalloutBox", LazyCalloutBox],
  ["ChecklistBox", LazyChecklistBox],
  ["CodeBlock", LazyCodeBlock],
  ["ComparisonTable", LazyComparisonTable],
  ["FeatureGrid", LazyFeatureGrid],
  ["HighlightBox", LazyHighlightBox],
  ["ImageComparison", LazyImageComparison],
  ["NewsletterSignup", LazyNewsletterSignup],
  ["ProConsList", LazyProConsList],
  ["QuoteBlock", LazyQuoteBlock],
  ["ReadingProgress", LazyReadingProgress],
  ["ResourceCard", LazyResourceCard],
  ["ShareButtons", LazyShareButtons],
  ["StatsGrid", LazyStatsGrid],
  ["StepList", LazyStepList],
  ["TableOfContents", LazyTableOfContents],
  ["TimelineBlock", LazyTimelineBlock],
  ["TipBox", LazyTipBox],
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CiF8UiCH.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DXkbvAnU.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DVlU5w0h.mjs'));
...
export { useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useAppConfig as d, entry$1 as default, useSupabaseUser as e, asyncDataDefaults as f, createError as g, useRoute as h, useState as i, useRequestEvent as j, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
