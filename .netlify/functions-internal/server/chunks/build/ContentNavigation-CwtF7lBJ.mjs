...
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-BYQHWqEv.mjs';
import { u as useContentPreview } from './preview-CdOJLZif.mjs';
import { i as useState, b as useRuntimeConfig } from './server.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-v-Eo_WxA.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-CwtF7lBJ.mjs.map
