      ...
      <div class="max-w-4xl mx-auto">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-blue-100 text-lg">{{ resumeData.personalInfo.title || 'Professional' }}</p>
     ...
     <div class="max-w-4xl mx-auto p-8">
       ...
       <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
         ...
         <div class="space-y-6">
           ...
           <div class="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-200">
             ...
             <div class="flex justify-center mb-4">
               <div class="relative inline-flex items-center justify-center w-24 h-24">
                 ...
                 <span class="absolute text-xl font-bold text-gray-900">{{ coverLetterData.alignmentScore || 0 }}%</span>
               </div>
             </div>
           ...
           <div v-if="coverLetterData.companyHighlights && coverLetterData.companyHighlights.length > 0" class="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-200">
             ...
             <div class="space-y-4">
               <div
                 ...
                 :key="index"
                 class="bg-white rounded-xl p-4 border border-gray-200 shadow-sm hover:shadow-md transform hover:scale-105 transition-all duration-300"
               >
                 <!-- Company Name -->
                 <h4 class="font-bold text-lg text-gray-900 mb-3 text-center">
                   {{ company.companyName }}
                 </h4>
       ...
       <div v-if="coverLetterData.alignedSkills && coverLetterData.alignedSkills.length > 0" class="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-2xl p-6 border-l-4 border-indigo-500">
         ...
         <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
           <div
             ...
             :key="index"
             class="bg-white rounded-xl p-4 border border-gray-200 shadow-sm hover:shadow-md transform hover:scale-105 transition-all duration-300 flex items-center justify-center min-h-[80px]"
           >
